...
/**
 * Tradition-specific calculation engine for Udupi Ashta Mathas.
 * Follows Sri Madhvacharya lineage, Udupi Ashta Matha customs, and coastal Tuluva conventions.
 */
class UdupiAshtaMathaTraditionEngine : IShraddhaTraditionEngine {

    override val tradition: MadhwaTradition = MadhwaTradition.UDUPI_ASHTA_MATHA
        ...
        for (yearIdx in 2..maxYearIdx) {
            ...
            val varshikaEvent = ShraddhaEvent(
                ...
                explanation = if (isEkadashi) {
                    ...
                    "Annual death anniversary according to Sri Udupi Ashta Matha customs in ${eventPanchanga.masaDisplayName}. ${selectedVarshika.evaluationReason}"
                },
