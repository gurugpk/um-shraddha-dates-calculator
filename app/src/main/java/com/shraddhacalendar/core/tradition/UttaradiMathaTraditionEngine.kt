...
/**
 * Tradition-specific calculation engine for Sri Uttaradi Matha.
 * Follows Amanta lunar calendar, strict Aparahna Vyapti, and Jayateertha / Smriti Muktavali principles.
 */
class UttaradiMathaTraditionEngine : IShraddhaTraditionEngine {

    override val tradition: MadhwaTradition = MadhwaTradition.UTTARADI_MATHA
    ...
    override fun calculateYearlyObservanceGroups(
        ...
        // Calculate Year 1 Masikas and 1st Varshika
        ...
        val year1Group = YearlyObservanceGroup(
            ...
            masikas = year1MasikaEvents.dropLast(1), // First 16 events
        ...
        // Calculate up to current year and next upcoming year
        ...
        for (yearIdx in 2..maxYearIdx) {
            // Chain-forward: use previous year's actual Varshika date + ~354 days (lunar year)
            ...
            val varshikaEvent = ShraddhaEvent(
                ...
                explanation = if (isEkadashi) {
                    ...
                    "Annual death anniversary according to Sri Uttaradi Matha Panchanga in ${eventPanchanga.masaDisplayName}. ${selectedVarshika.evaluationReason}"
                },
            ...
            // Calculate Mahalaya Paksha for this year (Bhadrapada Krishna Paksha)
            ...
            // Expand by default if this is the active current/upcoming year
